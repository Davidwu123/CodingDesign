...
import com.study.design.pattern.creation.factory.method.IPlayerFactory;
import com.study.design.pattern.creation.factory.method.PlayerFactoryMap;
import com.study.design.pattern.creation.factory.simple.SimplePlayerFactory;
...
//        player = SimplePlayerFactoryV3.create("exo");
        Log.d(com.study.design.pattern.creation.singleton.TestMain.class, "simpleFactory player instance2 is " + player.toString());
    ...
    private static void executeFactoryMethod() {
        ...
        Log.d(com.study.design.pattern.creation.singleton.TestMain.class, "FactoryMethod instance1 is " + player.toString());
        player = playerFactory.create();
        Log.d(com.study.design.pattern.creation.singleton.TestMain.class, "FactoryMethod instance2 is " + player.toString());

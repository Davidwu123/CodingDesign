package com.study.design.pattern.behavior.chain;

import com.study.design.common.Log;
import com.study.design.pattern.behavior.chain.linkedList.HandlerChain;
import com.study.design.pattern.behavior.chain.linkedList.HighHandler;
import com.study.design.pattern.behavior.chain.linkedList.LowHandler;
import com.study.design.pattern.behavior.chain.linkedList.MiddleHandler;
import com.study.design.pattern.behavior.chain.list.HandlerV2Chain;
import com.study.design.pattern.behavior.chain.list.HighV2Handler;
import com.study.design.pattern.behavior.chain.list.LowV2Handler;
import com.study.design.pattern.behavior.chain.list.MiddleV2Handler;
import com.study.design.pattern.behavior.chain.wordFilter.AdsWordFilter;
import com.study.design.pattern.behavior.chain.wordFilter.PoliticalWordFilter;
import com.study.design.pattern.behavior.chain.wordFilter.SensitiveWordFilterChain;
import com.study.design.pattern.behavior.chain.wordFilter.SexyWordFilter;
